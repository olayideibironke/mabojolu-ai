...
const IMAGE_REQUEST_PATTERN = /\b(?:generate|create|draw|make|render|produce|show|print|design)\b[\s\S]{0,120}\b(?:image|picture|photo|photograph|illustration|artwork|portrait|graphic|flyer|poster|banner|invitation|birthday card|greeting card)\b|\b(?:image|picture|photo|photograph|illustration|artwork|portrait|graphic|flyer|poster|banner|invitation|birthday card|greeting card)\b[\s\S]{0,120}\b(?:of|for|showing|depicting|with)\b/i;
